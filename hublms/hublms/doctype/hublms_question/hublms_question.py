...
from hublms.hublms.utils import has_course_instructor_role, has_course_moderator_role


class HublmsQuestion(Document):
	def validate(self):
...
def get_question_details(question):
	...
	return frappe.db.get_value("Hublms Question", question, fields, as_dict=1)
