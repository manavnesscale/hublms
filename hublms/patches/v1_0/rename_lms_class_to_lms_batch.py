...
def execute():
	if frappe.db.exists("DocField", {"fieldname": "students", "parent": "Hublms Batch"}):
		return
...
def rename_lms_class():
	...
	rename_doc("DocType", "Hublms Class", "Hublms Batch")
	frappe.flags.ignore_route_conflict_validation = False
	frappe.reload_doctype("Hublms Batch", force=True)
